This is a modified version of the Apple example project "Capturing depth using the LiDAR camera" that can be found here:
...
![Overview of Changes Made to Apple Example](changes_diagram.png)
